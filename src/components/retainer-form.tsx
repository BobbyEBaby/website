...
export function RetainerForm() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      matterReference: String(fd.get("matterReference") ?? "").trim(),
      amountCad,
  ...
  return (
    ...
    >
      ...
      <h3 className="font-display text-2xl text-[color:var(--color-forest-900)]">
        Deposit funds into trust.
      </h3>
      <p className="text-sm text-[color:var(--color-ink-700)] leading-relaxed">
        Type the amount of the retainer agreed with your lawyer. You&rsquo;ll
        be handed off to Stripe to enter your card.
      </p>
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <Field
          ...
          autoComplete="off"
          optional
          hint="If your lawyer gave you one."
        />
        <AmountField />
      </div>
      ...
      <label className="block">
        ...
        <textarea
          ...
          placeholder="e.g. initial retainer for the Smith family matter"
        />
      </label>
      ...
      <div className="flex flex-wrap items-center gap-4 pt-1">
        ...
        <p className="text-xs text-[color:var(--color-ink-500)] leading-relaxed">
          Funds are deposited into the firm&rsquo;s pooled trust account.
        </p>
      </div>
    </form>
  );
